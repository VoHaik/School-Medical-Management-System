...
export const getAllMedicalEvents = async () => {
  try {
    ...
    handleApiError(error, 'fetch medical events');
  }
};

export const createMedicalEvent = async (eventData) => {
  try {
    const response = await apiClient.post('/medical-events', eventData);
    return response.data;
  } catch (error) {
    handleApiError(error, 'create medical event');
  }
};

export const updateMedicalEvent = async (eventId, eventData) => {
  try {
    const response = await apiClient.put(`/medical-events/${eventId}`, eventData);
    return response.data;
  } catch (error) {
    handleApiError(error, 'update medical event');
  }
};

export const deleteMedicalEvent = async (eventId) => {
  try {
    const response = await apiClient.delete(`/medical-events/${eventId}`);
    return response.data;
  } catch (error) {
    handleApiError(error, 'delete medical event');
  }
};
...
export const getSystemConfig = async () => {
  try {
    ...
    handleApiError(error, 'fetch system configuration');
  }
};
...
export const updateSystemConfig = async (configData) => {
  try {
    ...
    handleApiError(error, 'update system configuration');
  }
};
