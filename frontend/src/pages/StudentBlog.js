        ...
        return (
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background: `linear-gradient(135deg, ${category.color || theme.palette.primary.main} 0%, ${category.color2 || theme.palette.secondary.main} 100%)`,
                ...
                >
                    <div className="d-flex justify-content-between align-items-center">
                        <div className="d-flex align-items-center gap-3">
                            <div
                                className="category-icon p-3 rounded-circle"
                                style={{fontSize: '1.3rem', background: 'rgba(255,255,255,0.15)'}}
                            >
                                {category.icon}
                            </div>
                            <div>
                <span className="badge fw-normal px-3 py-2 rounded-pill" style={{background: 'rgba(255,255,255,0.15)', color: theme.palette.getContrastText(category.color || theme.palette.primary.main)}}>
                  {category.name}
                </span>
                                <div className="mt-2">
                                    <small style={{color: 'rgba(255,255,255,0.7)'}} className="d-flex align-items-center">
                        ...
                        {showActions && (
                            <div className="dropdown">
                                <button
                                    ...
                                    style={{fontSize: '1.2rem', color: theme.palette.getContrastText(category.color || theme.palette.primary.main)}}
                                >
                ...
                <div className="card-body p-4">
                    <h4 className="card-title fw-bold mb-3" style={{color: theme.palette.text.primary, lineHeight: '1.3'}}>
                        {post.title}
                    </h4>

                    {post.summary && (
                        <div className="summary-section mb-4 p-3 rounded-3" style={{
                            backgroundColor: theme.palette.mode === 'dark' ? '#23272f' : '#f8fafc',
                            borderLeft: `4px solid ${category.color || theme.palette.primary.main}`,
                            fontSize: '1rem',
                            color: theme.palette.text.secondary
                        }}>
                            <i className="fas fa-quote-left me-2" style={{color: category.color || theme.palette.primary.main}}></i>
                        ...
                        {isExpanded ? (
                            <div>
                                <div
                                    ...
                                    style={{
                                        whiteSpace: 'pre-wrap',
                                        backgroundColor: theme.palette.mode === 'dark' ? '#23272f' : '#fafbfc',
                                ...
                                <button
                                    ...
                                    style={{transition: theme.transitions.create(['background', 'color'])}}
                                >
                            ...
                            <div>
                                <p style={{fontSize: '1rem', lineHeight: '1.6', color: theme.palette.text.secondary}}>
                                ...
                                {post.content && post.content.length > 150 && (
                                    <button
                                        ...
                                        style={{background: category.color || theme.palette.primary.main, border: 'none', color: theme.palette.getContrastText(category.color || theme.palette.primary.main), transition: theme.transitions.create(['background', 'color'])}}
                                    >
                    ...
                    {post.tags && Array.isArray(post.tags) && post.tags.length > 0 && (
                        <div className="tags-section mt-4 pt-3" style={{borderTop: `1px solid ${theme.palette.divider}`}}>
                    ...
                    <div className="col-12">
                        ...
                        <div className="text-center mb-5">
                            <div className="hero-section p-5 rounded-4 shadow-lg mb-4" style={{
                                background: `linear-gradient(135deg, ${theme.palette.primary.main} 0%, ${theme.palette.card.main} 100%)`,
                                color: theme.palette.text.primary,
                                position: 'relative',
                                overflow: 'hidden',
                                boxShadow: theme.shadows[1]
                                ...
                                <div style={{position: 'relative', zIndex: 1}}>
                                    <h1 className="display-3 fw-bold mb-3" style={{color: theme.palette.text.primary}}>
                                        <i className="fas fa-hospital-alt me-3"></i>
                                        Student Health Blog
                                    </h1>
                                    <p className="lead fs-4 mb-4" style={{color: theme.palette.text.secondary}}>
                                    ...
                                    {isStudent && (
                                        <div className="mt-4">
                                            <button
                                                ...
                                                onMouseOut={(e) => {
                                                    e.target.style.transform = 'translateY(0)';
                                                    e.target.style.boxShadow = theme.shadows[1];
                                                }}
                                            >
                        ...
                        <div className="nav-tabs-container mb-5">
                            <div className="card border-0 shadow-sm rounded-3" style={{background: theme.palette.card.main, color: theme.palette.text.primary}}>
                                <div className="card-body p-0">
                                    <ul className="nav nav-pills nav-fill p-3 m-0" style={{background: theme.palette.background.paper, borderRadius: '0.75rem'}}>
                                        <li className="nav-item">
                                            <button
                                                ...
                                                style={{
                                                    transition: 'all 0.3s ease',
                                                    border: 'none',
                                                    backgroundColor: activeTab === 'all' ? theme.palette.primary.main : 'transparent',
                                                    color: activeTab === 'all' ? theme.palette.getContrastText(theme.palette.primary.main) : theme.palette.text.secondary,
                                                    fontSize: '1rem'
                                                }}
                                            >
                                                ...
                                                <span className="badge ms-2" style={{
                                                    backgroundColor: activeTab === 'all' ? 'rgba(255,255,255,0.2)' : theme.palette.background.paper,
                                                    color: activeTab === 'all' ? theme.palette.getContrastText(theme.palette.primary.main) : theme.palette.text.secondary
                                                }}>
                                                    {Array.isArray(allPosts) ? allPosts.length : 0}
                                                </span>
                                        ...
                                        <li className="nav-item">
                                            <button
                                                ...
                                                style={{
                                                    transition: 'all 0.3s ease',
                                                    border: 'none',
                                                    backgroundColor: activeTab === 'my' ? theme.palette.primary.main : 'transparent',
                                                    color: activeTab === 'my' ? theme.palette.getContrastText(theme.palette.primary.main) : theme.palette.text.secondary,
                                                    fontSize: '1rem'
                                                }}
                                            >
                                                ...
                                                My Posts
                                                <span className="badge ms-2" style={{
                                                    backgroundColor: activeTab === 'my' ? 'rgba(255,255,255,0.2)' : theme.palette.background.paper,
                                                    color: activeTab === 'my' ? theme.palette.getContrastText(theme.palette.primary.main) : theme.palette.text.secondary
                                                }}>
                                                    {Array.isArray(posts) ? posts.length : 0}
                                                </span>
